...
def test_fusion_keeps_cv_bbox_and_applies_qwen_semantics():
    ...
    vision = {"confidence": 0.9, "elements": [
        {"ocrId": "ocr_1", "role": "main_title", "semanticType": "text", "groupId": "header_1", "visionConfidence": 0.9},
        {"id": "shape_001", "role": "icon", "semanticType": "icon", "groupId": "header_1", "visionConfidence": 0.8},
